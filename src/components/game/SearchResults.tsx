...
import type { SearchStatus } from './useMovieSearch'
...
export default function SearchResults({
  ...
  onResultPointerDown?: (e: React.PointerEvent) => void
}) {
  ...
  return (
    <div className="flex flex-col gap-2 pt-1">
      {status === 'idle' && (
        <p className="text-sm text-[var(--fg-muted)]">Start typing to find movies.</p>
      )}
